...
CREATE TABLE `storagespaces` (
  `StorageSpaceId` int(11) NOT NULL AUTO_INCREMENT,
  `StorageSpaceName` varchar(225) NOT NULL,
...
INSERT INTO `storagespaces` VALUES (1,'Cutia albastra',NULL),(2,'Lada de lemn',1);
